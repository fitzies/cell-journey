...
`transfer-horizontal-linear.svg` is the standard line Solar icon by 480 Design, distributed under CC BY 4.0 through Iconify:

- Source: https://api.iconify.design/solar/transfer-horizontal-linear.svg
- Collection: https://icon-sets.iconify.design/solar/
